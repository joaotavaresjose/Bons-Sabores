                ...
                <div className="max-w-2xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-lg p-8 scale-in">
                        <div className="text-center mb-8 fade-in-up">
                            <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4 bounce-in">
                                <i className="fas fa-user text-orange-500 text-3xl"></i>
                            </div>
